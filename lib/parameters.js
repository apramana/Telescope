...
getParameters = function (terms) {
  ...
  if(typeof terms.locLatMin != 'undefined' && typeof terms.locLatMax != 'undefined')
    _.extend(parameters.find, {locLat: { $gt: terms.locLatMin, $lt: terms.locLatMax }});
  
  if(typeof terms.locLongMin != 'undefined' && typeof terms.locLongMax != 'undefined')
    _.extend(parameters.find, {locLong: { $gt: terms.locLongMin, $lt: terms.locLongMax }});
