...
getMarkerIcon = function(post){
  //if(post._id == Session.get('selectedMkr'))
    //return L.icon({'iconUrl': 'http://www.sociotopia.com/icons/marker-icon-selected.png'}); // TODO: replace personal URL with relpath
  if(post.categories.length != 0)
    return L.icon({'iconUrl': 'http://www.sociotopia.com/icons/'+post.categories[0].slug+'.png'});
  return L.icon({'iconUrl': 'http://www.sociotopia.com/icons/marker-icon.png'});
}